...
Sub GetPatients(Form)
	...
	Set results = json.Decode(HTTP.responseText)
	Dim patients : patients = results("patients")
	For Each patient In patients
		Call Form.Fields.Field("Patients").AddListItem(patient("firstname") & " " & patient("lastname") & " - " & patient("patientid"), patient("patientid"))
	Next
End Sub
